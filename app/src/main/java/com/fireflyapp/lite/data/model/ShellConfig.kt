...
data class ShellConfig(
    ...
    val topBarHeightDp: Int = 60,
    val topBarIconSizeDp: Int = 24,
    ...
    val bottomBarHeightDp: Int = 68,
    val bottomBarIconSizeDp: Int = 22,
    ...
    val navigationPreloadCount: Int = 0,
