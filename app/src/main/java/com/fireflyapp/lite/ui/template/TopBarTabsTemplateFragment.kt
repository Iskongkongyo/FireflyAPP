...
class TopBarTabsTemplateFragment : Fragment(), TemplateHost, BackPressHandler, WebPageCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tabsColor = TemplateThemeStyler.resolveDisplayedThemeColor(
        ...
        binding.tabsContainer.setBackgroundColor(tabsColor)
    ...
    private fun syncNavigationStateFromCurrentUrl(updateTitleFallback: Boolean) {
        ...
        if (navigationChanged) {
            ...
            selectTabByItemId(items, matchedItemId)
        }
    ...
    private fun applyStatusBarTheme() {
        ...
        when {
            pageWantsTopBar -> TemplateThemeStyler.applyTopBarStatusBarTheme(
                ...
                fallbackView = binding.toolbar,
                shadowDp = mainViewModel.requireConfig().shell.topBarShadowDp
            )
            ...
            pageWantsTabs -> TemplateThemeStyler.applyTopBarStatusBarTheme(
                ...
                fallbackView = binding.tabs,
                shadowDp = mainViewModel.requireConfig().shell.bottomBarShadowDp
            )
